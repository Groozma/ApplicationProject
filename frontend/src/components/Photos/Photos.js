...
function Photos() {
  // Displays gallery images with descriptive alt text for SEO and accessibility
  return (
    <div className="photos">
      ...
      <img
        src={photo3}
        alt="A group of kids sitting around in a circle"
        className="photo"
      />
      <img
        src={photo4}
        alt="A pair of teenagers in a bathing suit wrapped around by a towel"
        className="photo"
      />
      <img src={photo5} alt="A teenage girl in a costume" className="photo" />
      <img
        src={photo6}
        alt="A group of kids watching a play"
        className="photo"
      />
      ...
      <img
        src={photo9}
        alt="A pair of staff covered in silly string"
        className="photo"
      />
      <img src={photo10} alt="A pair of staff in costumes" className="photo" />
      <img
        src={photo11}
        alt="A teenager holding a bunch of recycleables"
        className="photo"
      />
      <img
        src={photo12}
        alt="A pair of staff in the pool smiling"
        className="photo"
      />
      <img src={photo13} alt="Three staff wearing costumes" className="photo" />
      <img
        src={photo14}
        alt="A pair of kids jumping off a diving board"
        className="photo"
      />
    </div>
  );
